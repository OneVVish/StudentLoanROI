---
title: Parent PLUS: the slow road and the fast road
description: A new Parent PLUS loan has one repayment plan and the balance sets its length. Two ways to carry the capped $65,000, priced with the calculator, and the age you make the last payment.
summary: A Parent PLUS loan taken from July 2026 has one fixed plan, and its length is set by the balance when each loan enters repayment. That leaves parents two real choices. One costs about a third as much in interest. The other ends when many parents are past 65.
date: 2026-09-08
hero: guide-hero-parent-plus-slow-road-fast-road-klein4b.png
---
...
This guide prices both roads on the capped $65,000, borrowed as four loans of $16,250, at 9.07 percent. That is the rate the Department set for Direct PLUS loans first disbursed between July 1, 2026 and June 30, 2027, announced on June 4, 2026, so it is exactly what a freshman-year loan carries. The rate for each later year is set the spring before it and none of those exist yet, so pricing all four at 9.07 percent is an assumption about three years rather than a fact. It then asks the question the aid letter never does: how old will you be when the last payment clears. Every figure below is rounded and carries a tilde; the caps and the term bands are the law's own numbers and are exact. The retirement age is assumed to be 65, and an age at the last payment is the age in the year that payment falls.

## The slow road: defer, and take the schedule

Deferment is a box on the PLUS application, and it has to be requested. Without it, repayment on each year's loan begins 60 days after that year's last disbursement. With it, nothing is due while the student is enrolled at least half time. The six months after enrollment ends is a second deferment under 34 CFR 685.204(c)(2)(ii) and it is also granted on request, so a parent who asks for one and not the other starts paying in the grace period. Interest does not defer. It runs on each loan from the day it is disbursed, and when the four loans leave deferment together, six months after the student leaves school, it is added to the balance.

On the capped loan that is about ~$17,700 of interest accrued during school and the six months after, so the balance entering repayment is roughly ~$82,700. That total sits in the 20-year band, and all four loans get 20 years.

| The slow road | Figure |
| --- | --- |
| Paid during school | $0 |
| Monthly payment after graduation | ~$750 for 20 years |
| Interest during school and the six months after | ~$17,700 |
| Interest during repayment | ~$96,800 |
| Total interest | ~$114,400 |
...
| --- | --- |
| Peak monthly payment | ~$695, in the senior year |
| Total interest | ~$56,400 |
| Last payment | 23 years after the freshman fall |

That road ends almost as late as the slow one but costs about half the interest. The difference between it and the slow road is entirely the deferral: not deferring saves roughly ~$58,000 of interest before any prepayment at all. Deferral buys the lowest payment during school, which is nothing, and a higher one after it: the slow road's ~$750 is above this road's ~$695 peak, because of the interest that was added to the balance. The difference between it and the fast road is the prepayment, which buys the other ~$22,300 and ten years.
...
A payment that runs into retirement is a payment made from retirement income, and Parent PLUS does not go away at 65. A defaulted federal loan can be collected from Social Security benefits. It does end at death: under 34 CFR 685.212(a) the loan is discharged if the parent dies or if the student it was borrowed for dies, and under 685.212(b) if the parent becomes totally and permanently disabled, so it does not pass to a spouse or an estate. That is the fact behind the table, and it is the reason the freshman-fall decision is worth making on purpose.
...
It does not model the older plans. A parent already repaying a Parent PLUS loan made before July 1, 2026 keeps the 10-year Standard plan for that loan, and the 25-year Extended plan as well if more than $30,000 is still outstanding, which is the floor the regulation sets on that plan. For them the choice looks different; [the earlier guide on the cap](/guides/parent-plus-senior-year) covers what those loans carry.

It leaves out the origination fee. Every PLUS disbursement carries a 4.228 percent fee, so borrowing $65,000 delivers about ~$62,250 to the school and the family repays the full $65,000; the calculator can include it. And it assumes the four loans are equal and that all four carry the freshman year's published 9.07 percent. Rates are set each spring for the year beginning July 1, so the sophomore, junior and senior loans each carry a rate nobody knows yet, and every figure here moves proportionally with them. The calculator's own working assumption is 8.5 percent, which puts the slow road at ~$104,900 rather than ~$114,400: about ~$9,500 of difference on one child, from half a point of interest across twenty years. A family that borrows less than the cap may land in a shorter band, and the bands are the one plannable thing on this plan. Total borrowing under $50,000 is a 15-year loan on the slow road; under $25,000, a 10-year one.

## Run your own road

The repayment tool now takes each loan with the month it is disbursed and the month of its first payment, sets each loan's term the way the rule does, and adds the interest that accrues in between. The three roads above are prefilled: [the slow road](/?tool=repayment&from=guide&rb=16250,16250,16250,16250&rr=9.07,9.07,9.07,9.07&rdis=0,12,24,36&re=54,54,54,54&rf=0), [paying as you go](/?tool=repayment&from=guide&rb=16250,16250,16250,16250&rr=9.07,9.07,9.07,9.07&rdis=0,12,24,36&re=2,14,26,38&rf=0), and for the fast road the same as-you-go grid, where the Standard (10-year) row is the payment at that pace. Change the balances, the rate and the months to your own, enter your age, and it says how old you will be at the last payment on the plan you select. To see whether the degree the loan is buying pays it back, [the calculator](/?from=guide) takes the school, the major and the loan and measures the result against not going at all.
