...
A second study reaches the same corner of the labor market from a different direction, which is worth more than another paper agreeing with this one. Sam Manning and Tomas Aguirre, working through the Centre for the Governance of AI, pair an occupational exposure measure with something nobody had built before: an adaptive capacity index, an estimate of how easily the people in a job could move to another one, from their savings, their age, the density of the local labor market and how transferable their skills are. It covers 356 occupations and 95.9 percent of the American workforce, and its headline finding is reassuring in a way most coverage of this subject is not. Exposure and adaptability move together. Of the 37.1 million workers in the most exposed quartile, 26.5 million are in occupations whose workers also score above the median for getting out.

The residual is the finding. About 6.1 million workers, 4.2 percent of their sample, are both highly exposed and least able to move, and they are concentrated in clerical and administrative work. That is the same corner this guide arrives at by counting occupations rather than workers: 52 of the 59 High-band careers needing no bachelor's degree are office and administrative support. Two methods, one built on task overlap and one on the capacity to leave, landing on the same desks. The Washington Post's account of the research adds that the authors put women at about 86 percent of that group.

The dimension they added is one this site cannot supply. Adaptive capacity needs savings, an age and a local labor market for each worker, and the calculator has none of the three; a score invented for it would be the kind of confident number this app declines to print elsewhere for the same reason. What the study changes here is the caveat above rather than any figure below it. The population that looks least able to absorb a shock is the one on the other side of this site's comparison.
