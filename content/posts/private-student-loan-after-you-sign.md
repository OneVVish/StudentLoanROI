---
title: A private student loan, after you have signed
description: Why the payment is what it is, what interest-only and refinancing change, what a cosigner is worth, and what this site cannot price when the payment cannot be made.
summary: A private student loan has none of the federal fallbacks, so once it exists the questions are arithmetic. Here is that arithmetic on real balances from r/StudentLoans: the payment, interest-only, refinancing, the cosigner, and the one section that is not arithmetic at all.
date: 2026-09-08
hero: guide-hero-private-student-loan-after-you-sign-klein4b.png
---

The private-loan threads on r/StudentLoans this month have the same shape. A balance with a bank's name on it, a rate between 11 and 18 percent, a first payment that is a third or half of a paycheck, and a question that starts with "what are my options." The federal loan guides on this site are about options, because federal loans have them. A private loan has almost none, and that is the first thing to say plainly: no income-driven payment, no forgiveness at the end, no federal rules about forbearance, discharge on death or disability only if the contract says so, and a cosigner who owes every dollar if the borrower stops.

So once the loan exists, most of the questions are arithmetic, and arithmetic can be shown. Every figure below is computed with this site's repayment tool on balances taken from those threads, rounded and carrying a tilde. The rates and balances are theirs, quoted as posted. The one section that is not arithmetic is marked as such.
...
| The loan, as posted | Monthly payment over ten years | Of the first payment, interest |
| --- | --- | --- |
...
One thread this month was a loan that had grown to three times what was borrowed. No fee or trick is needed for that. A balance compounding at 15 percent doubles in about five years and triples in a little under eight, so a loan that goes unpaid or mostly unpaid through the years after graduation reaches that figure on the arithmetic alone. Partial payments that fall short of the month's interest do not stop it; they slow it. The lesson is not about the borrower. It is that on a private loan, time without a full payment is the most expensive thing there is, because there is no plan that pauses the clock.
...
| $59,000, as posted at 11 percent | Monthly | Total interest |
| --- | --- | --- |
...
Two things from the threads that this site cannot price. A refinance is a credit decision, and several borrowers were declined because their federal minimums pushed the debt-to-income ratio past the lender's line; [parking the federal loans on the lowest legitimate plan](/guides/when-the-federal-minimum-comes-back) is what moves that ratio, and it is the federal side's job. And some lenders want a payment history before they will refinance a loan. What that history is varies by lender and is not published anywhere this site can cite, so the honest instruction is to ask the lender directly rather than to assume a number read on a forum.

## What a cosigner is worth, and what it costs them

A borrower this month posted three offers on a $15,000 loan: 17.8 percent as it stood, 8 percent to refinance alone, 5.71 percent to refinance with a cosigner.
...
Everything above is for a loan that exists. The threads also carried the other question, from a transfer student facing a $12,000 semester with $5,500 of federal room and a nursing admit needing $80,000 in private money. For them the arithmetic runs the other way and is cheaper to do now. [The calculator](/?from=guide) prices whatever sits above the federal caps as private money, at a stated rate, and says what share of the first paycheck that payment takes. [The school search](/?tool=schools&from=guide) finds the price that needs no private loan at all, and [the guide on where the federal money runs out](/guides/where-the-federal-money-runs-out) says how often it does.

## Run your own numbers

Most private borrowers hold federal loans too, and the repayment tool prices the two sides together. [It opens here](/?tool=repayment&from=guide&rb=30000&rr=6&rhp=1&rpb=52000&rpr=12&rpt=10&ri=60000) on a portfolio from one of the threads, $30,000 federal beside $52,000 private, with the rates and income assumed. Enter your own balances, rates and terms, and it prices every federal plan beside the private payment, says which loan an extra dollar should go to and why, and, with your age entered, says how old you will be at the last payment.
