...
from workers_ai import (                                     # noqa: E402
    MODELS, NON_COMMERCIAL, credentials, generate)
...
PROMPTS = {
    ...
    "college-roi-rankings": (
        ...
        "shot from a low side angle with shallow depth of field, no people. "
        "Documentary photography, muted natural colour, quiet and still. No "
        "legible text, no charts, no screens showing content.",
        20260832, 4),
...
def build(slug: str, dry_run: bool = False, model: str = "klein4b"):
    ...
    raw = generate(prompt, seed, steps, acct, token, model, size=BAND)
